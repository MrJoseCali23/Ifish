...
<head>
    <meta charset="UTF-8">
    <title>Iniciar sesión - IFish</title>
...
<div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="login-container p-5" style="width: 100%; max-width: 480px;">
        <div class="text-center mb-4">
    <img src="{{ asset('images/logo.png') }}" alt="IFish Logo" style="width: 100%; max-width: 200px;" class="img-fluid">
</div>
